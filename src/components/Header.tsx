							...
							<div className="absolute right-0 mt-2 w-56 rounded-wiseXl border border-wise-ink/20 bg-wise-canvas shadow-lg dark:border-wise-canvasSoft/20 dark:bg-wise-ink">
								...
								<div className="space-y-1 p-2">
									<button
										...
										className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-slate-900 transition hover:bg-slate-100 dark:text-slate-100 dark:hover:bg-slate-800"
									>
										<svg
											className="h-4 w-4"
											fill="none"
