		...
		<div className="flex flex-col p-5 gap-5">
			...
			<dl className="grid grid-cols-2 gap-y-4 gap-x-3">
				...
				<InfoRow label="Status">
					<span
						className={`inline-flex px-2 py-0.5 rounded-md text-xs font-semibold ${statusStyles[ticket.status].text} ${statusStyles[ticket.status].bg}`}
					>
						{ticket.status}
					</span>
				</InfoRow>
				...
				<InfoRow label="Priority">
					<span
						className={`inline-flex px-2 py-0.5 rounded-md text-xs font-semibold ${priorityStyles[ticket.priority]}`}
					>
				...
				<InfoRow label="Category">
					<span
						className={`inline-flex px-2 py-0.5 rounded-md text-xs font-semibold ${categoryStyles[ticket.category]}`}
					>
						{ticket.category}
					</span>
				</InfoRow>
				...
				<InfoRow label="Due By">
					<span
						className={`text-xs font-medium ${isOverdue ? "text-dc-error dark:text-dc-error-dark" : "text-emerald-600 dark:text-emerald-400"}`}
					>
				...
				<InfoRow label="Officer">
					{officer ? (
						...
						<span className="text-dc-error dark:text-dc-error-dark font-medium">
							Unassigned
						</span>
					)}
				</InfoRow>
				...
				<InfoRow label="Escalated">
					<span
						className={`text-xs font-semibold ${ticket.isEscalated ? "text-dc-error dark:text-dc-error-dark" : "text-emerald-600 dark:text-emerald-400"}`}
					>
